...
class FlaskAImage:
    ...
    def to_embedding(self) -> list[float]:
        ...
        # Using Facenet512 to get a 512 length vector
        embeddings = DeepFace.represent(self.__numpy_image, model_name='Facenet512')
    ...
    def to_file(self):
        """
        Converts the detected face into a Flask file
        """
        
        return send_file(self.to_bytes(), mimetype="image/jpeg")
